...
public class UserFrame extends JFrame {
    ...
    private JPanel createFormPanel() {
        ...
        // Button Save - Warna Biru Modern
        btnSave = new JButton("Save");
        btnSave.setPreferredSize(new Dimension(75, 30));
        btnSave.setBackground(new Color(52, 152, 219)); // Blue
        btnSave.setForeground(Color.WHITE);
        buttonPanel.add(btnSave);
        
        // Button Update - Warna Orange Modern
        btnUpdate = new JButton("Update");
        btnUpdate.setPreferredSize(new Dimension(75, 30));
        btnUpdate.setBackground(new Color(243, 156, 18)); // Orange
        btnUpdate.setForeground(Color.WHITE);
        buttonPanel.add(btnUpdate);
        
        // Button Delete - Warna Merah Modern
        ...
        // Button Cancel - Warna Abu-abu Modern
        btnCancel = new JButton("Cancel");
        btnCancel.setPreferredSize(new Dimension(75, 30));
        btnCancel.setBackground(new Color(149, 165, 166)); // Gray
